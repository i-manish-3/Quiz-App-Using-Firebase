...
import com.example.quizzer.databinding.FragmentWalletBinding;
        ...
        binding.sendRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(user.getCoins() >= 50000){
                    ...
                    String upi = binding.upiId.getText().toString();
                    WithdrawRequest request = new WithdrawRequest(uid, upi, user.getName());
